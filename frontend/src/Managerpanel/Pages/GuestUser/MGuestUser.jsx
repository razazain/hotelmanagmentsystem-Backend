            ...
            <div className="row align-items-center">
              <div className="col">
                <div className="mt-5">
                  ...
                  <Link to="/MaddGuest" className="btn btn-primary float-right veiwbutton">Add Guest</Link>
                </div>
              </div>
            </div>
          </div>
                            ...
                            <td className="text-right">
                              <div className="dropdown dropdown-action">
                                ...
                                <div className="dropdown-menu dropdown-menu-right">
                                  <Link className="dropdown-item" to={`/MeditGuest/${guest._id}`}>
