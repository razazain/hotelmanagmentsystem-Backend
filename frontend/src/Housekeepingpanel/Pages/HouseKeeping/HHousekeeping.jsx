            ...
            <div className="row align-items-center">
              <div className="col">
                <div className="mt-5">
                  ...
                  <Link to="/HAddHousekeeping" className="btn btn-primary float-right veiwbutton">Add Task</Link>
                </div>
              </div>
            </div>
          </div>
                            ...
                            <td className="text-right">
                              <div className="dropdown dropdown-action">
                                ...
                                <div className="dropdown-menu dropdown-menu-right">
                                  <Link className="dropdown-item" to={`/HEditHousekeepingrec/${task._id}`}>
